    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(choices=[('GENERAL', 'General'), ('HARDWARE', 'Hardware Items'), ('SOFTWARE', 'Software Items'), ('PAPER_ROLLS', 'Paper Rolls')], default='GENERAL', help_text='Item category section', max_length=20, verbose_name='Section')),
