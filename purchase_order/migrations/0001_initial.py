    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(choices=[('GENERAL', 'General'), ('SERVICE', 'Service Items'), ('SOFTWARE', 'Softwares')], default='GENERAL', help_text='Item category section', max_length=20, verbose_name='Section')),
