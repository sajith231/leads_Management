    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True)),
                ('section', models.CharField(choices=[('GENERAL', 'General'), ('HARDWARE', 'Hardware'), ('SOFTWARE', 'Software'), ('PAPER_ROLLS', 'Paper Rolls'), ('OTHER', 'Other')], default='GENERAL', max_length=50, verbose_name='Section')),
                ('unit_of_measure', models.CharField(default='pcs', max_length=50, verbose_name='Unit of Measure')),
                ('mrp', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Maximum Retail Price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customerType', models.CharField(default='Business', help_text='Determines which input group to show', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_number', models.CharField(blank=True, max_length=50, null=True, verbose_name='Ticket Number')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='purchase_order.item', verbose_name='Item')),
                ('lead', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requirements', to='app5.lead')),
            ],
        ),
        migrations.CreateModel(
            name='ReturnItem',
