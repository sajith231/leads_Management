...
class ServiceEntry(models.Model):
    ...
    mode_of_service = models.CharField(max_length=20, choices=MODE_CHOICES, default='Onsite') #CREATED AS NEW
    service_type = models.CharField(max_length=20, choices=SERVICE_TYPE_CHOICES, default='Software')  #CREATED AS NEW
    user = models.ForeignKey(User, on_delete=models.CASCADE)
